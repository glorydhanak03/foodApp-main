...
const Gallery = () => {
  return (
    <div>
      ...
      btnCustom={"border-white text-white bg-transparent z-10 hover:bg-[#f76e2a] hover:border-black hover:text-black px-4 py-2 rounded transition duration-200 ease-in-out text-sm sm:text-base md:text-lg"}
